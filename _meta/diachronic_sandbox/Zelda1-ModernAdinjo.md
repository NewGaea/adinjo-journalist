...
```ngloss
\ex NYORU CORI KÉRIN, HIRO ESTAG "GANNON" WIN JONDEIRIN I DEIRIN SAUKENTOT.
\gl nyor-u [nyore-nu] [year-PL] [years]
	coridul [cori-dul] [some-INT] [many]
	kérin [kérin] [before] [before]
	hiro [hiro] [king] [king]
	estag [estag] [shadow] [shadow]
	GANNON [GANNON] [GANNON] [Gannon]
	win [win] [one] [one]
	jon-deirin [jon-deirin] [three-power] [Triforce]
	i [i] [of] [of]
	deirin [deirin] [power] [power]
	sauken-tot [sauken-tot] [take.command-PAST] [took command]
\ft Some years ago, King Shadow "GANNON" took control of one Triforce of Power.
```

### PRINCESS ZELDA HAD ONE OF THE TRIFORCE WITH WISDOM.`
```ngloss
\ex KAIROTAL ZELDA WIN JONEIRINU I CHIJIN CHUMATOLOT.
\gl kairotal [kairo-tal] [queen-small] [Princess]
	ZELDA [ZELDA] [ZELDA] [Zelda]
	sug [sug] [DEF] [the]
	jon-deirin [jon-deirin] [thee-power] [Triforce]
	i [i] [of] [of]
	chijin [chijin] [wisdom] [wisdom]
	chuma-t-ol-ot [chuma-t-ol-ot] [own-PASS.PAST] [had.ownership]
\ft Queen ZELDA had ownership of the Triforce of Wisdom.
```

### SHE DIVIDED IT INTO 8 UNITS TO HIDE IT FROM "GANNON" BEFORE SHE WAS CAPTURED.

```ngloss
\ex FI KOSIJ AMKEILU SUG JONDEIRIN'TAK, XI "GANNON"TAK UMASHTOT.
\gl fi [fi] [she] [She]
	kosij [kosij] [eight] [eight]
	amkei-l-u [amkei-l-nu] [cut-GER-PL] [parts]
	sug [sug] [DEF] [the]
	jon-deirin [jon-deirin] [three-power] [Triforce]
	xi [xi] [it] [it]
	GANNON [GANNON] [GANNON] [Gannon]
...
\ft She made eight pieces from the Triforce, and hid them from "GANNON."
```
...
```ngloss
\ex LINK! A8 AMKEILU AIRENTOCHI!
\gl LINK [LINK] [Link]
	a-kosij [UNIV-eight] [all eight]
	amkei-lu [to.cut-PL] [pieces]
...
```ngloss
\ex JALMETÈN
\gl jal-metèn [jalu-metèn] [land-illustration] [map]
\ft Map
```
...
```ngloss
\ex XÁPONTAX
\gl xá-pont-tax [xá-pontifar-yuga] [magic-direction-AGENT]
\ft Magic Compass
```
...
```ngloss
\ex JONDEIRIN
\gl jon-deirin [jon-deirin] [three-power]
\ft Triforce
```
