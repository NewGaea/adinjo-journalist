...
Adinjo Journalist has 26 letters (_dakmelu_) and the _adobat_ is ordered loosely as in Ancient Greek. Most of these letters correspond to sounds also present in modern English.
...
Formal romanization is the standard used throughout this documentation, using one-to-one romanization for every letter, yet allowing several digraphs to have a single letter as well.
