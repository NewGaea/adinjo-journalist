...
The simple participle is formed by dropping the final vowel of the **infinitive** (and this will break diphthongs), unless this means dropping the only vowel in the stem, and any letters following it. This form may still be conjugated for tense, based on the result. Thus, **faileton** (loves) would become **failton** (loving) and **anitochi** (will be) would become **antochi** ((will be) being) to form their respective participles. TON verb participles may be of any tense (past, present or future), but are always in the active voice.
