...
- [x] [**ajan**](lexicon/a/ajan.md) 1. (_p noun, title_) the Lord, My God; a title used when referring one's patron deity or spirit (att. 2002-Jul-31)
- [x] [**aramdekçin**](lexicon/a/aramdekçin.md) 1. (_noun_) password, passcode (att. 2015-Mar-16; cf. _aramel_, _dekcin_; formerly _aradekchin_)
- [x] [**aram.èl**](lexicon/a/aram.md) 1. (_ton verb_) passing, going through, going beyond (att. 2002-Jul-31)
...
- **gìl** 1. (_noun_) a flat (or flattened) circular animal shell 2. (_noun, slang_) `a.` shortened form of _gildern_ or _gìldèn_, the name of international gold coins on Atrusius `b.` a coin of any denomination or material 3. (_noun, slang_) the price of an item in a store or catalog (att. 2022-Jun-23)
...
- **greis** 1. (_noun_) compassion, mercy (att. 2008-Jun-22 ${\rightarrow}$ 2023-Jan-13)
...
- **metèn** 1. (_noun_) illustration, drawing (an older word that never made it into the lexicon; doc. 2022-Oct-25)
...
- **ragunes** 1. (_noun_) mercenary (att. 2009-Nov-06)
