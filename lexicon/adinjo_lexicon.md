...
- [x] **-a** 1. (_generic suffix_) no, not, negative (att. 2003-Dec-25; cf. _ha_) 2. (**-a-**) (_kun verb affix_) no, not; replaces the last vowel in the root (att. 2003-Dec-25; cf. _ha_)
- [x] **a-** 1. (_noun prefix_) all, each, every (att. 2003-Dec-25)
- [x] **a-** 1. (_descriptor prefix_) great, grand, superior (att. 2003-Dec-25)
- [x] **absau** 1. (_descriptor_) grey (att. 2018-Dec-31)
- [x] **abse** 1. (_descriptor_) black (att. 2002-Jul-31)
- [x] **abso** 1. (_descriptor_) white (att. 2002-Jul-31)
- [x] **ábul** 1. (_noun_) monument (att. 2002-Jul-31)
- [x] **adan** 1. (_pronoun_) any, any one, no specific one (att. 2005-Nov-04)
- [x] **ademba** 1. (_pronoun_) any time, one time (att. 2022-Jun-01; cf. _temba_)
- [x] **adin** 1. (_pronoun_) the people (universal, conceptual) (att. 1998-Jun-01) 2. (_noun_) people, universal (att. 1998-Jun-01; cf. **dyn**) 3. (_noun_) any of the Adin, anybody belonging to the species _Homo sapiens medeis_
- [x] **adinjo** 1. (_noun_) a language of the Adin people
- [x] **aduprani** 1. (_descriptor_) pansexual (att. 2022-Jun-04)
- [x] **ace** 1. (_noun_) creature (att. 2003-Dec-25)
- [x] **acoré.ru** 1. (_ton verb_) unfold, open, bloom or blossom (att. 2003-Dec-25)
- [x] **aimei** 1. (_descriptor_) visible (att. UNKNOWN)
- [x] **aimi** 1. (_noun_) eye (att. 2002-Jul-31)
- [x] **aimijálun** 1. (_noun_) blindfold, eye patch (att. 2023-Jan-28)
- [x] **aire.nd** 1. (_ton verb_) finding, learning, discovering (att. 2003-Dec-25)
- [x] **-aiti** 1. (_suffix, gender_) a suffix indicating a feminine aspect, gender, or nature; a suffix added to a name to indicate it belongs to a female (possibly a form of _daiti_ or _naiti_; att. 2003-Dec-25)
- [x] **akar** 1. (_positional_) through, beyond (att. 2007-Dec-29)
- [x] **akendan** (_noun_) high tale, great legend, grand fantasy (form of **kendan**; att. 2005-Nov-04)
- [x] **aki** 1. (_pronoun_) all of us, everybody here (att. 2022-Jun-24)
- [x] **albor** 1. (_noun_) tar (*allegedly* derived from _abse_ + _tlor_; att. 2003-Dec-25) 2. (_noun_) ink, oil paint
- [x] **ald** 1. (_descriptor_) old (att. 2007-Dec-29)
- [x] **aldjin** 1. (_noun_) old blood, established names or families 2. (_noun_) Adin with bloodline traits (att. 2007-Dec-29)
- [x] **aldyur** 1. (_descriptor_) ancient, very old, antique (att. 2007-Nov-26; red. 2022-Jun-05)
- [x] **alma.ru** 1. (_ton verb_) ruling, leading, governing (att. 2008-Jun-22; formerly _aluma.ru_)
- [x] **almán** 1. (_noun_) leader by circumstance, acting leader 2. director, team leader
- [x] **almatax** 1. (_noun_) leader by profession, manager
- [x] **alme.n** 1. (_ton verb_) milking (att. 2003-Dec-25)
- [x] **almenin** 1. (_descriptor_) milky, of a consistency or color like milk (att. 2021-Apr-21), creamy (att. 2022-Jun-27)
- [x] **almer** 1. (_noun_) milk 2. magical potion (att. 2003-Dec-25; formerly _alman_)
- [x] **alnogalmi** 1. (_descriptor_) lawful, legal, legitimate (att. 2023-Jan-20_)
- [x] **alnom** 1. (_noun_) a rule or law (att. UNKNOWN)
- [x] **alren** 1. (_noun_) twin; a sibling born at the same time as another (att. 2008-Jun-22)
- [x] **amarau** 1. (_descriptor_) crying, weeping, mourning (att. 2022-Jun-27)
- [x] **amar.te** 1. (_ton verb_) crying, weeping, mourning (att. 2021-Apr-22)
- [x] **amén** 1. (_expression_) a voicing of agreement; a valediction used to conclude a wish, prayer, or request, serving as a call to action; to invoke or call to action (att. 2002-Jul-31)
- [x] **amend** 1. (_descriptor_) awake; alert; in a state of readiness for action (att. 2002-Jul-31)
- [x] **amen.ru** 1. (_ton verb_) waking, awakening, invoking, calling upon (att. 2002-Jul-31)
- [ ] **amkei.l** 1. (_ton verb_) cutting, splitting, separating, removing, shearing; dividing (att. 2002-Jul-31)
- [ ] **amur.ent** 1. (_ton verb_) scattering, spreading, sowing (att. 2003-Dec-25)
- [ ] **an-** 1. (_prefix, descriptor_) expresses that the word is a statement of state or status, “to be x” (att. 2003-Dec-25) 2. (_prefix, noun_) sex, gender, class (att. 2008-Jun-22)
- [ ] **andaiti** 1. (_descriptor_) female (att. 2008-Jun-22; cf. _anjyu_, _daiti_)
- [ ] **andèn** 1. (_descriptor_) holy, divine, sacred (att. 2008-Jun-22)
- [ ] **andènau** 1. (_noun_) divinity (att. 2022-Jun-27)
- [ ] **andenin** 1. (_noun_) holiness (att. 2021-Apr-22)
...
- [ ] **anèn** 1. (_descriptor_) male (att. 2008-Jun-22; cf. _anjyu_, _nen_)
...
- [ ] **ani.ru** 1. (_ton verb_) being (as in, “to be or not to be…”) (att. 2002-Jul-31)
